...
{
    int count;
    coutnEnter total students who like vanilla ;
    cincount;
    for (int i = 0; i  count; i++)
    {
        append(&vanilla_head);
    }
    coutnStudents who like vanilla ;
    display_list(&vanilla_head);
}
void get_butter()
{
    int count;
    coutnEnter total students who like butterscotch ;
    cincount;
    for (int i = 0; i  count; i++)
    {
        append(&butter_head);
    }
    coutnStudents who like butterscotch ;
...
int main()
{
    ...
    do
    {
        coutn1. To enter data;
        coutn2. To display the rollnos of students who like vanila or butterscotch;
        coutn3. To display the rollnos of students who like only vanila;
        coutn4. To display the rollnos of students who like only butterscotch;
        coutn5. To display the rollnos of students who like both vanila and butterscotch ;
        coutn6. To display the rollnos of students who neither like vanila nor butterscotch;
        coutn7. Exit;
        coutnEnter choice ;
        cinchoice;
        switch (choice)
        {
            case 1
                ...
                break;
            case 2
                coutStudents who like vanilla or butterscotch ;
                display_list( unio(&vanilla_head, &butter_head) );
                break;
            case 3
                coutStudents who like only vanilla ;
                display_list(&vanilla_head);
                break;
            case 4
                coutStudents who like butterscotch ;
                display_list(&butter_head);
                break;
            case 5
                coutStudents who like both vanilla and butterscotch ;
                display_list( inters(&vanilla_head, &butter_head) );
                break;
            case 6
                coutStudents who like neither vanilla nor butterscotch ;
